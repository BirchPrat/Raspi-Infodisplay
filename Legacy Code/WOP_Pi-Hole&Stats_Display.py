...
def sysinfogather():
    ...
    return [IP, HOST, CPU, MemUsage, Disk, Temp]
...
while True:
    ...
    while buttonApushed == 1:  # just button A pressed
        if buttonB.value == True:
            buttonBpushed == 1
            buttonApushed == 0
    ...
    while buttonBpushed == 1:
        if buttonA.value == True:
            ...
            #draw.text((x, y), stats[0], font=font, fill="#FFFF00")
            """
